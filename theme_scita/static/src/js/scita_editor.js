odoo.define('theme_scita.scita_editor_js', function(require) {
    ...
    options.registry.theme_scita_category_slider = options.Class.extend({
        ...
        cat_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/theme_scita/category_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.second_category_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
    ...
    options.registry.theme_scita_product_slider = options.Class.extend({
        ...
        prod_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/theme_scita/product_get_options', 'call', {}).done(function(res) {
                    $('#slider_type option[value!="0"]').remove();
                    _.each(res, function(y) {
                        $("select[id='slider_type'").append($('<option>', {
                            value: y["id"],
    ...
    options.registry.scita_multi_cat_custom_snippet = options.Class.extend({
        ...
        multi_category_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/theme_scita/product_multi_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.health_blog_custom_snippet = options.Class.extend({
        ...
        theme_scita_blog_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                ajax.jsonRpc('/theme_scita/blog_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.blog_7_custom_snippet = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
            this.$target.find('.blog_7_custom').empty();
            
            if (!editMode) {
                self.$el.find(".blog_7_custom").on("click", _.bind(self.theme_scita_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
