...
odoo.define('theme_scita.scita_general_js', function(require) {
    ...
    // recommended_products_slider
        ...
        if (localStorage.getItem("product_view") == '4-grid') {
            ...
            //number slider count start
                ...
                $(".myNumCarousel .carousel-control-next").click(function(){
                ...
                $(".myNumCarousel .carousel-control-prev").click(function(){
    ...
    $(window).load(function() {
        ...
        $('li.o_extra_menu_items li.li-mega-menu').click(function(event) {
    ...
    function equal_height_prod() {
        function resetHeightReddy() {
            var maxHeight = 0;
                ...
                jQuery("span.sct-pro-menu-name").height("auto").each(function() {
    ...
    function equal_height_all() {
        function resetHeight() {
            var maxHeight = 0;
            jQuery(".it-icon h4").height("auto").each(function() {
                maxHeight = $(this).height() > maxHeight ? $(this).height() : maxHeight;
            }).height(maxHeight);
            jQuery(".myourteam .image-container").height("auto").each(function() {
                maxHeight = $(this).height() > maxHeight ? $(this).height() : maxHeight;
            }).height(maxHeight);
            jQuery(".it_blogs .blog-thumb").height("auto").each(function() {
                maxHeight = $(this).height() > maxHeight ? $(this).height() : maxHeight;
            }).height(maxHeight);
            jQuery(".case_study_varient_2 .case_study_box").height("auto").each(function() {
                maxHeight = $(this).height() > maxHeight ? $(this).height() : maxHeight;
            }).height(maxHeight);
        }
        resetHeight();
